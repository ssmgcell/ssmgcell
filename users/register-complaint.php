...
<html lang="en">
  <head>
    ...
    <title>SSM GMS | User Register Complaint</title>
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">Complaint Details (max 6000 words) </label>
<div class="col-sm-6">
<textarea  name="complaindetails" required="required" cols="10" rows="10" class="form-control" maxlength="6000"></textarea>
</div>
</div>
<div class="form-group">
